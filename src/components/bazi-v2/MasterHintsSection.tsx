  ...
  return (
    <section className="mt-8 rounded-xl border border-golddim/25 bg-silk2 p-6">
      <div className="flex items-center justify-between">
        ...
        <span className="rounded-full border border-golddim/40 px-4 py-1.5 text-[12px] tracking-[0.1em] text-inkmuted">
        ...
        {hints.map((h) => (
          <li key={h.ruleId} className="rounded-lg border border-golddim/15 bg-white/40 p-4">
            <div className="flex flex-wrap items-center gap-2">
              ...
              <span className="rounded bg-deep px-2 py-0.5 font-mono text-[12px] tracking-[0.08em] text-goldbright">
                {h.ruleId}
              </span>
              <span className="text-[12px] text-golddim">{h.master}</span>
            </div>
