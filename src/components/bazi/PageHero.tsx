    ...
    <section className="relative flex min-h-[24vh] flex-col overflow-hidden bg-deep sm:min-h-[30vh] lg:min-h-[38vh]">
      ...
      <div className="relative z-10 flex flex-1 flex-col items-center justify-center px-4 py-12 text-center sm:px-6 sm:py-14">
        <motion.div
          ...
          className="flex h-24 w-24 items-center justify-center rounded-2xl border border-gold/40 font-serif text-[56px] font-black text-goldbright"
        >
          {glyph}
        </motion.div>
        ...
        <motion.p
          ...
          className="mt-4 max-w-xl text-[15px] leading-[1.9] text-silktext/80"
        >
          {sub}
        </motion.p>
      </div>
