    ...
    <div className="relative min-h-screen overflow-hidden bg-deep2">
      ...
      <div
        ...
        style={{
          ...
          animation: "zifu-breathe 20s ease-in-out infinite",
        }}
      />
      ...
      <div className="zf-container relative z-10 flex min-h-screen flex-col items-center justify-center py-20">
        ...
        >
          ...
          <h1 className="mt-6 font-serif text-[clamp(34px,4.5vw,40px)] font-bold leading-[1.5] tracking-[0.16em] text-inktext">
            以古人之智
            <span className="mx-3 text-golddim">·</span>
            照今日之心
          </h1>
          <p className="mt-5 font-serif text-[13px] leading-[2.1] tracking-[0.04em] text-inkmuted">
            问一事，摇一卦；想看清这一生，排一盘。
        ...
        >
          ...
          <Link
            to="/liuyao"
            className="group relative overflow-hidden rounded-2xl border border-gold/45 bg-gold/[0.07] px-7 py-9 text-center transition-all duration-300 hover:border-gold hover:bg-gold/[0.13] hover:shadow-[0_0_40px_rgba(201,164,92,0.14)] sm:col-span-3"
          ...
          >
            ...
            />
            <p className="font-serif text-[24px] font-bold tracking-[0.18em] text-goldbright">凡事爻一爻</p>
        ...
        >
          ...
          <Link
            to="/jianlu"
            className="group flex items-baseline gap-2 font-serif transition-colors hover:text-golddim"
          >
