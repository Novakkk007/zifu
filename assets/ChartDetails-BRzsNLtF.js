...
}`,ho=JSON.parse(po);function mo({term:t,children:e,className:n}){const r=ho[t];if(!r)return n?a.jsx("span",{"code-path":"src\\components\\GlossaryTooltip.tsx:47:7",className:n,children:e??t}):a.jsx(a.Fragment,{children:e??t});const o=r.books.map(s=>cn.find(i=>i.id===s)).filter(s=>s!==void 0);return a.jsxs(lo,{"code-path":"src\\components\\GlossaryTooltip.tsx:58:5",children:[a.jsx(fo,{"code-path":"src\\components\\GlossaryTooltip.tsx:59:7",className:xe("cursor-help touch-manipulation bg-transparent p-0 text-left [color:inherit] [font:inherit] [letter-spacing:inherit] [line-height:inherit]","underline decoration-dotted decoration-golddim/60 underline-offset-4 transition-[text-decoration-color]","hover:decoration-golddim focus-visible:decoration-golddim focus-visible:outline-none",n),children:e??t}),a.jsxs(uo,{"code-path":"src\\components\\GlossaryTooltip.tsx:70:7",side:"top",sideOffset:6,className:"w-[280px] rounded-xl border border-gold/25 bg-deep2 px-5 py-4 shadow-card",children:[a.jsx("p",{"code-path":"src\\components\\GlossaryTooltip.tsx:75:9",className:"font-serif text-[15px] font-bold tracking-[0.12em] text-goldbright",children:t}),a.jsx("p",{"code-path":"src\\components\\GlossaryTooltip.tsx:78:9",className:"mt-2 text-[12.5px] leading-[1.9] text-silktext",children:r.def}),o.length>0&&a.jsxs("div",{"code-path":"src\\components\\GlossaryTooltip.tsx:80:11",className:"mt-3 border-t border-gold/15 pt-2.5",children:[a.jsx("p",{"code-path":"src\\components\\GlossaryTooltip.tsx:81:13",className:"text-[11px] tracking-[0.14em] text-silkmuted",children:"相关典籍 · 藏经阁"}),a.jsx("ul",{"code-path":"src\\components\\GlossaryTooltip.tsx:82:13",className:"mt-1.5 flex flex-wrap gap-x-3 gap-y-1",children:o.map(s=>a.jsx("li",{"code-path":"src\\components\\GlossaryTooltip.tsx:84:17",children:a.jsxs(Ze,{"code-path":"src\\components\\GlossaryTooltip.tsx:85:19",to:"/wiki",className:"text-[12px] text-goldbright/90 underline decoration-gold/40 underline-offset-4 transition-colors hover:text-goldbright",children:["《",s.title,"》"]})},s.id))})]})]})]})}const et={delingMin:20,supportMin:10,reverseSupportMin:24,strongTotal:42},st="邵伟华审订体系",le="https://www.sizhuyucexue.com/thread-65-1-1.html",de="https://www.sizhuyucexue.com/thread-73-1-1.html",xo="https://www.sizhuyucexue.com/thread-74-1-1.html",go="https://www.sizhuyucexue.com/thread-1336-1-1.html",bo=[{id:"SWH-01",master:st,source:le,evaluate(t){const e=t.wuxing.strength;return e.deling>=et.delingMin&&e.dedi+e.deshi>=et.supportMin?{title:"日主偏强倾向（月令优先审查）",text:`日主五行属${t.dayMasterWuxing}，月令得令（${e.deling}/40），兼有得地得势支持（${e.dedi+e.deshi}/60）。传统旺衰审查先看月令，此盘呈现偏强倾向；仍请继续核对克泄耗、合化与支持力量，此非最终强弱结论。`}:null}},{id:"SWH-02",master:st,source:le,evaluate(t){const e=t.wuxing.strength;return e.deling<et.delingMin&&e.dedi+e.deshi>=et.reverseSupportMin?{title:"失令但有反转可能",text:`日主失令（月令 ${e.deling}/40），但得地得势合计 ${e.dedi+e.deshi}/60 已构成多处有力生助。传统上「失令不即定弱」：若生助力量可抵月令之失，存在由弱转中和的可能，建议降低强弱结论置信度并做全局复核。`}:null}},{id:"SWH-03",master:st,source:xo,evaluate(t){const e=t.dayMasterWuxing,n={木:"金",火:"水",土:"木",金:"火",水:"土"},r={木:"水",火:"木",土:"火",金:"土",水:"金"},o=n[e],s=r[e],i=t.wuxing.count;return!(t.wuxing.strength.total>=et.strongTotal)&&i[o]>=2.5&&i[o]>=i[e]*1.2?{title:"身弱官杀偏多：印星优先",text:`日主属${e}而${o}（官杀）偏多（计 ${i[o]}），传统取用优先考察${s}（印星）能否泄官杀生身；印不可用时再察比劫帮身，且两者都须检查受制与副作用。`}:null}},{id:"SWH-04",master:st,source:de,evaluate(t){const e=t.dayMasterWuxing,n={木:"水",火:"木",土:"火",金:"土",水:"金"},r={木:"土",火:"金",土:"水",金:"木",水:"火"},o=n[e],s=r[e],i=t.wuxing.count;return t.wuxing.strength.total>=et.strongTotal?null:i[s]>=2.5&&i[s]>=i[o]*1.5?{title:"身弱财多：比劫优先",text:`日主属${e}而${s}（财星）偏多（计 ${i[s]}），身弱财多传统上反为累。平衡方向：先考察比劫（${e}）分财帮身，再考察印星（${o}）。`}:null}},{id:"SWH-05",master:st,source:de,evaluate(t){const e=t.dayMasterWuxing,n={木:"水",火:"木",土:"火",金:"土",水:"金"},r={木:"土",火:"金",土:"水",金:"木",水:"火"},o=n[e],s=r[e],i=t.wuxing.count;return t.wuxing.strength.total>=et.strongTotal&&i[o]>=2.5&&i[o]>=i[s]*1.5?{title:"身强印多：财星制印",text:`日主属${e}而${o}（印星）偏多（计 ${i[o]}），身强印多宜抑耗。传统方向：优先考察${s}（财星）制印耗身，并复核官杀、食伤是否加重冲突。`}:null}},{id:"SWH-07",master:st,source:go,evaluate(t){return t.shensha.length===0?null:{title:"神煞降权参详",text:`本盘命中神煞：${t.shensha.slice(0,3).map(n=>n.name).join("、")}（共 ${t.shensha.length} 项）。传统运用以「原局优先、神煞佐证」为原则：神煞只作性格与行动主题的辅助参考，不与旺衰喜忌同向时权重降低，不据此作出具体事件判断。`}}}],Nt="梁湘润体系",fe="https://books.google.com/books?id=Dc4rQwAACAAJ",vo="https://www.chinyuan.com.tw/all_book/more?id=9322",ue={寅:{season:"春",wuxing:"木",name:"木旺"},卯:{season:"春",wuxing:"木",name:"木旺"},辰:{season:"春",wuxing:"木",name:"木旺"},巳:{season:"夏",wuxing:"水",name:"夏火旺需润"},午:{season:"夏",wuxing:"水",name:"夏火旺需润"},未:{season:"夏",wuxing:"水",name:"夏火旺需润"},申:{season:"秋",wuxing:"金",name:"金旺"},酉:{season:"秋",wuxing:"金",name:"金旺"},戌:{season:"秋",wuxing:"金",name:"金旺"},亥:{season:"冬",wuxing:"火",name:"冬水寒需暖"},子:{season:"冬",wuxing:"火",name:"冬水寒需暖"},丑:{season:"冬",wuxing:"火",name:"冬水寒需暖"}},wo={木:"水",火:"木",土:"火",金:"土",水:"金"},pe={木:"土",火:"金",土:"水",金:"木",水:"火"},yo=[{id:"LXR-01",master:Nt,source:fe,evaluate(t){const e=t.pillars.month?.branch;if(!e)return null;const n=ue[e];if(!n||n.season!=="夏"&&n.season!=="冬")return null;const r=t.yongshen.yongshen;return r===n.wuxing||wo[n.wuxing]===r?{title:"三轨同向：调候与扶抑一致",text:`月支${e}属${n.season}（${n.name}），传统调候取${n.wuxing}；扶抑法用神为${r}，两轨方向一致。传统上同向证据可提高该平衡方向的参详权重——仍属文化参详，不代表现实事件必然发生。`}:null}},{id:"LXR-02",master:Nt,source:vo,evaluate(t){const e=t.pillars.month?.branch;if(!e)return null;const n=ue[e];if(!n||n.season!=="夏"&&n.season!=="冬")return null;const r=t.yongshen.yongshen;return r===pe[n.wuxing]||n.wuxing===pe[r]?{title:"三轨冲突：调候与扶抑相悖",text:`月支${e}属${n.season}，传统调候方向取${n.wuxing}，而扶抑法用神为${r}，两轨方向相反。传统上遇此情形应保留多个候选并降低唯一用神的置信度，不宜合并为单一定论。`}:null}},{id:"LXR-04",master:Nt,source:fe,evaluate(t){const e=t.wuxing.strength.grade;return e==="偏强"||e==="偏弱"?{title:"旺衰层限定说明",text:`本盘旺衰量化等级「${e}」（总分 ${t.wuxing.strength.total}/100）。此结论只用于扶抑层面的参考，不能覆盖调候或格局层面的判断——不同观察维度结论不同时，以并列呈现为准。`}:null}}];function Co(t,e=6){const n=[];for(const r of[...bo,...yo]){const o=r.evaluate(t);o&&n.push({ruleId:r.id,master:r.master,source:r.source,...o})}return n.slice(0,e)}function Oo({chart:t}){const e=g.useMemo(()=>Co(t),[t]);return e.length===0?null:a.jsxs("section",{"code-path":"src\\components\\bazi-v2\\MasterHintsSection.tsx:15:5",className:"mt-8 rounded-xl border border-golddim/25 bg-silk2 p-6",children:[a.jsxs("div",{"code-path":"src\\components\\bazi-v2\\MasterHintsSection.tsx:16:7",className:"flex items-center justify-between",children:[a.jsxs("div",{"code-path":"src\\components\\bazi-v2\\MasterHintsSection.tsx:17:9",children:[a.jsx("p",{"code-path":"src\\components\\bazi-v2\\MasterHintsSection.tsx:18:11",className:"font-latin text-[11px] font-medium uppercase tracking-[0.3em] text-golddim",children:"Master Perspectives"}),a.jsx("h3",{"code-path":"src\\components\\bazi-v2\\MasterHintsSection.tsx:21:11",className:"mt-1 font-serif text-[20px] font-bold tracking-[0.08em] text-inktext",children:"名家视角 · 参详提示"})]}),a.jsx("span",{"code-path":"src\\components\\bazi-v2\\MasterHintsSection.tsx:25:9",className:"rounded-full border border-golddim/40 px-4 py-1.5 text-[11px] tracking-[0.1em] text-inkmuted",children:"传统方法论蒸馏 · 文化参考 · 不构成决策建议"})]}),a.jsx("ul",{"code-path":"src\\components\\bazi-v2\\MasterHintsSection.tsx:29:7",className:"mt-5 space-y-3",children:e.map(n=>a.jsxs("li",{"code-path":"src\\components\\bazi-v2\\MasterHintsSection.tsx:31:11",className:"rounded-lg border border-golddim/15 bg-white/40 p-4",children:[a.jsxs("div",{"code-path":"src\\components\\bazi-v2\\MasterHintsSection.tsx:32:13",className:"flex flex-wrap items-center gap-2",children:[a.jsx("span",{"code-path":"src\\components\\bazi-v2\\MasterHintsSection.tsx:33:15",className:"font-serif text-[15px] font-bold text-inktext",children:n.title}),a.jsx("span",{"code-path":"src\\components\\bazi-v2\\MasterHintsSection.tsx:34:15",className:"rounded bg-deep px-2 py-0.5 font-mono text-[10.5px] tracking-[0.08em] text-goldbright",children:n.ruleId}),a.jsx("span",{"code-path":"src\\components\\bazi-v2\\MasterHintsSection.tsx:37:15",className:"text-[11.5px] text-golddim",children:n.master})]}),a.jsx("p",{"code-path":"src\\components\\bazi-v2\\MasterHintsSection.tsx:39:13",className:"mt-2 text-[13.5px] leading-[1.9] text-inkmuted",children:n.text})]},n.ruleId))})]})}const $="whitespace-nowrap border-b border-golddim/25 px-3 py-2.5 text-left font-sans text-[12px] font-medium tracking-[0.1em] text-golddim",_="border-b border-golddim/10 px-3 py-2.5 align-top text-[13px] leading-[1.8] text-inktext";function Xt({children:t,caption:e}){return a.jsx("div",{"code-path":"src\\components\\bazi-v2\\ChartDetails.tsx:18:5",className:"overflow-x-auto rounded-xl border border-golddim/25 bg-silk2 shadow-card",children:a.jsxs("table",{"code-path":"src\\components\\bazi-v2\\ChartDetails.tsx:19:7",className:"w-full min-w-[720px] border-collapse",children:[a.jsx("caption",{"code-path":"src\\components\\bazi-v2\\ChartDetails.tsx:20:9",className:"px-4 pb-0 pt-4 text-left font-serif text-[15px] font-bold tracking-[0.12em] text-inktext",children:e}),t]})})}const Ro={比肩:"同我（比和）",劫财:"同我（比和）",食神:"我生（泄秀）",伤官:"我生（泄秀）",偏财:"我克（财星）",正财:"我克（财星）",七杀:"克我（官杀）",正官:"克我（官杀）",偏印:"生我（印星）",正印:"生我（印星）"},Ao=new Set(["比肩","食神","偏财","七杀","偏印"]);function Eo({chart:t}){const e=new Map;for(const n of t.tenGods){if(n.tenGod==="日主")continue;const r=e.get(n.tenGod)??[];r.push({pillar:n.pillar,char:n.char,layer:n.layer==="stem"?"天干":"藏干"}),e.set(n.tenGod,r)}return a.jsxs(Xt,{"code-path":"src\\components\\bazi-v2\\ChartDetails.tsx:49:5",caption:"十神明细（天干透干 + 地支藏干全量）",children:[a.jsx("thead",{"code-path":"src\\components\\bazi-v2\\ChartDetails.tsx:50:7",children:a.jsxs("tr",{"code-path":"src\\components\\bazi-v2\\ChartDetails.tsx:51:9",children:[a.jsx("th",{"code-path":"src\\components\\bazi-v2\\ChartDetails.tsx:52:11",className:$,children:"十神"}),a.jsx("th",{"code-path":"src\\components\\bazi-v2\\ChartDetails.tsx:53:11",className:$,children:"来源（落柱 · 干支 · 层）"}),a.jsx("th",{"code-path":"src\\components\\bazi-v2\\ChartDetails.tsx:54:11",className:$,children:"与日主关系"}),a.jsx("th",{"code-path":"src\\components\\bazi-v2\\ChartDetails.tsx:55:11",className:$,children:"阴阳"}),a.jsx("th",{"code-path":"src\\components\\bazi-v2\\ChartDetails.tsx:56:11",className:$,children:"传统含义"}),a.jsx("th",{"code-path":"src\\components\\bazi-v2\\ChartDetails.tsx:57:11",className:$,children:"规则出处"})]})}),a.jsx("tbody",{"code-path":"src\\components\\bazi-v2\\ChartDetails.tsx:60:7",children:[...e.entries()].map(([n,r])=>{const o=tn[n];return a.jsxs("tr",{"code-path":"src\\components\\bazi-v2\\ChartDetails.tsx:64:13",children:[a.jsx("td",{"code-path":"src\\components\\bazi-v2\\ChartDetails.tsx:65:15",className:`${_} font-serif text-[15px] font-bold text-golddim`,children:a.jsx(mo,{"code-path":"src\\components\\bazi-v2\\ChartDetails.tsx:66:17",term:n,children:n})}),a.jsx("td",{"code-path":"src\\components\\bazi-v2\\ChartDetails.tsx:68:15",className:_,children:r.map((s,i)=>a.jsxs("span",{"code-path":"src\\components\\bazi-v2\\ChartDetails.tsx:70:19",className:"mr-2 inline-block whitespace-nowrap",children:[s.pillar,"·",s.char,a.jsxs("span",{"code-path":"src\\components\\bazi-v2\\ChartDetails.tsx:72:21",className:"ml-1 text-[11px] text-inkmuted",children:["（",s.layer,"）"]})]},i))}),a.jsx("td",{"code-path":"src\\components\\bazi-v2\\ChartDetails.tsx:76:15",className:_,children:Ro[n]??"—"}),a.jsx("td",{"code-path":"src\\components\\bazi-v2\\ChartDetails.tsx:77:15",className:_,children:Ao.has(n)?"与日主同阴阳":"与日主异阴阳"}),a.jsx("td",{"code-path":"src\\components\\bazi-v2\\ChartDetails.tsx:78:15",className:_,children:o?.meaning??"—"}),a.jsx("td",{"code-path":"src\\components\\bazi-v2\\ChartDetails.tsx:79:15",className:`${_} whitespace-nowrap text-[12px] text-inkmuted`,children:o?.source??"—"})]},n)})})]})}function No({chart:t}){return t.relations.length===0?a.jsxs("div",{"code-path":"src\\components\\bazi-v2\\ChartDetails.tsx:95:7",className:"rounded-xl border border-golddim/25 bg-silk2 p-8 text-center shadow-card",children:[a.jsx("p",{"code-path":"src\\components\\bazi-v2\\ChartDetails.tsx:96:9",className:"font-serif text-[15px] font-bold tracking-[0.12em] text-inktext",children:"合冲刑害破"}),a.jsx("p",{"code-path":"src\\components\\bazi-v2\\ChartDetails.tsx:97:9",className:"mt-3 text-[13px] text-inkmuted",children:"本命盘柱间未检出合、冲、刑、害、破关系。"})]}):a.jsxs(Xt,{"code-path":"src\\components\\bazi-v2\\ChartDetails.tsx:102:5",caption:"合冲刑害破（柱间关系）",children:[a.jsx("thead",{"code-path":"src\\components\\bazi-v2\\ChartDetails.tsx:103:7",children:a.jsxs("tr",{"code-path":"src\\components\\bazi-v2\\ChartDetails.tsx:104:9",children:[a.jsx("th",{"code-path":"src\\components\\bazi-v2\\ChartDetails.tsx:105:11",className:$,children:"类型"}),a.jsx("th",{"code-path":"src\\components\\bazi-v2\\ChartDetails.tsx:106:11",className:$,children:"柱位"}),a.jsx("th",{"code-path":"src\\components\\bazi-v2\\ChartDetails.tsx:107:11",className:$,children:"干支"}),a.jsx("th",{"code-path":"src\\components\\bazi-v2\\ChartDetails.tsx:108:11",className:$,children:"合化"}),a.jsx("th",{"code-path":"src\\components\\bazi-v2\\ChartDetails.tsx:109:11",className:$,children:"规则出处"})]})}),a.jsx("tbody",{"code-path":"src\\components\\bazi-v2\\ChartDetails.tsx:112:7",children:t.relations.map((e,n)=>a.jsxs("tr",{"code-path":"src\\components\\bazi-v2\\ChartDetails.tsx:114:11",children:[a.jsx("td",{"code-path":"src\\components\\bazi-v2\\ChartDetails.tsx:115:13",className:`${_} font-serif font-bold text-golddim`,children:e.type}),a.jsx("td",{"code-path":"src\\components\\bazi-v2\\ChartDetails.tsx:116:13",className:_,children:e.pillars.join(" · ")}),a.jsx("td",{"code-path":"src\\components\\bazi-v2\\ChartDetails.tsx:117:13",className:_,children:e.chars}),a.jsx("td",{"code-path":"src\\components\\bazi-v2\\ChartDetails.tsx:118:13",className:_,children:e.resultWuxing?`化${e.resultWuxing}`:"—"}),a.jsx("td",{"code-path":"src\\components\\bazi-v2\\ChartDetails.tsx:119:13",className:`${_} text-[12px] text-inkmuted`,children:e.source})]},`${e.type}-${e.chars}-${n}`))})]})}function $o({chart:t}){if(t.shensha.length===0)return a.jsxs("div",{"code-path":"src\\components\\bazi-v2\\ChartDetails.tsx:132:7",className:"rounded-xl border border-golddim/25 bg-silk2 p-8 text-center shadow-card",children:[a.jsx("p",{"code-path":"src\\components\\bazi-v2\\ChartDetails.tsx:133:9",className:"font-serif text-[15px] font-bold tracking-[0.12em] text-inktext",children:"神煞"}),a.jsx("p",{"code-path":"src\\components\\bazi-v2\\ChartDetails.tsx:134:9",className:"mt-3 text-[13px] text-inkmuted",children:"本盘未命中注册表内神煞。"})]});const e=[],n=new Map;for(const r of t.shensha){const o=n.get(r.name);o===void 0?(n.set(r.name,e.length),e.push({name:r.name,hits:[r]})):e[o].hits.push(r)}return a.jsxs(Xt,{"code-path":"src\\components\\bazi-v2\\ChartDetails.tsx:154:5",caption:"神煞（逐柱命中，同一神煞多柱命中分行列出）",children:[a.jsx("thead",{"code-path":"src\\components\\bazi-v2\\ChartDetails.tsx:155:7",children:a.jsxs("tr",{"code-path":"src\\components\\bazi-v2\\ChartDetails.tsx:156:9",children:[a.jsx("th",{"code-path":"src\\components\\bazi-v2\\ChartDetails.tsx:157:11",className:$,children:"名称"}),a.jsx("th",{"code-path":"src\\components\\bazi-v2\\ChartDetails.tsx:158:11",className:$,children:"命中柱位"}),a.jsx("th",{"code-path":"src\\components\\bazi-v2\\ChartDetails.tsx:159:11",className:$,children:"命中状态"}),a.jsx("th",{"code-path":"src\\components\\bazi-v2\\ChartDetails.tsx:160:11",className:$,children:"现代化说明"})]})}),a.jsx("tbody",{"code-path":"src\\components\\bazi-v2\\ChartDetails.tsx:163:7",children:e.flatMap(r=>r.hits.map((o,s)=>a.jsxs("tr",{"code-path":"src\\components\\bazi-v2\\ChartDetails.tsx:166:13",children:[a.jsxs("td",{"code-path":"src\\components\\bazi-v2\\ChartDetails.tsx:167:15",className:`${_} font-serif font-bold text-golddim`,children:[o.name,r.hits.length>1&&a.jsxs("span",{"code-path":"src\\components\\bazi-v2\\ChartDetails.tsx:170:19",className:"ml-1.5 rounded-full border border-golddim/30 px-1.5 py-0.5 align-middle font-sans text-[10px] font-normal text-inkmuted",children:[r.hits.length," 柱命中"]})]}),a.jsxs("td",{"code-path":"src\\components\\bazi-v2\\ChartDetails.tsx:175:15",className:`${_} whitespace-nowrap`,children:[o.pillar,a.jsxs("span",{"code-path":"src\\components\\bazi-v2\\ChartDetails.tsx:177:17",className:"ml-1 text-inkmuted",children:["（",o.char,"）"]})]}),a.jsx("td",{"code-path":"src\\components\\bazi-v2\\ChartDetails.tsx:179:15",className:`${_} whitespace-nowrap`,children:a.jsxs("span",{"code-path":"src\\components\\bazi-v2\\ChartDetails.tsx:180:17",className:"inline-block rounded-full border border-golddim/40 bg-golddim/10 px-2.5 py-0.5 text-[11.5px] tracking-[0.08em] text-golddim",children:["命中 · ",o.name,"·",o.pillar]})}),a.jsx("td",{"code-path":"src\\components\\bazi-v2\\ChartDetails.tsx:184:15",className:_,children:o.modernExplanation})]},`${r.name}-${o.pillar}-${o.char}-${s}`)))})]})}function _o({chart:t}){const e=t.chenggu;if(!e)return a.jsxs("div",{"code-path":"src\\components\\bazi-v2\\ChartDetails.tsx:199:7",className:"rounded-xl border border-golddim/25 bg-silk2 p-8 text-center shadow-card",children:[a.jsx("p",{"code-path":"src\\components\\bazi-v2\\ChartDetails.tsx:200:9",className:"font-serif text-[15px] font-bold tracking-[0.12em] text-inktext",children:"称骨"}),a.jsxs("p",{"code-path":"src\\components\\bazi-v2\\ChartDetails.tsx:201:9",className:"mt-3 text-[13px] text-inkmuted",children:["暂不可用",t.input.hour===null?"（时辰不详，称骨需时柱）":""]})]});const n=o=>`${(o/10).toFixed(1)} 两`,r=[{label:`年（${e.yearGanzhi}）`,q:e.yearQian},{label:`月（农历${e.lunarMonth}月）`,q:e.monthQian},{label:`日（${e.lunarDay}日）`,q:e.dayQian},{label:`时（${e.hourBranch}时）`,q:e.hourQian}];return a.jsxs("div",{"code-path":"src\\components\\bazi-v2\\ChartDetails.tsx:215:5",className:"rounded-xl border border-golddim/25 bg-silk2 p-7 shadow-card",children:[a.jsx("p",{"code-path":"src\\components\\bazi-v2\\ChartDetails.tsx:216:7",className:"text-center font-serif text-[15px] font-bold tracking-[0.12em] text-inktext",children:"称骨（袁天罡称骨歌）"}),a.jsx("div",{"code-path":"src\\components\\bazi-v2\\ChartDetails.tsx:219:7",className:"mt-5 grid grid-cols-2 gap-3 md:grid-cols-4",children:r.map(o=>a.jsxs("div",{"code-path":"src\\components\\bazi-v2\\ChartDetails.tsx:221:11",className:"rounded-lg border border-golddim/20 bg-silk px-3 py-3 text-center",children:[a.jsx("p",{"code-path":"src\\components\\bazi-v2\\ChartDetails.tsx:222:13",className:"text-[11.5px] tracking-[0.08em] text-inkmuted",children:o.label}),a.jsx("p",{"code-path":"src\\components\\bazi-v2\\ChartDetails.tsx:223:13",className:"mt-1 font-serif text-[16px] font-bold text-inktext",children:n(o.q)})]},o.label))}),a.jsxs("div",{"code-path":"src\\components\\bazi-v2\\ChartDetails.tsx:227:7",className:"mt-5 text-center",children:[a.jsx("p",{"code-path":"src\\components\\bazi-v2\\ChartDetails.tsx:228:9",className:"text-[11.5px] tracking-[0.16em] text-inkmuted",children:"总骨重"}),a.jsx("p",{"code-path":"src\\components\\bazi-v2\\ChartDetails.tsx:229:9",className:"mt-1 font-serif text-[34px] font-black leading-none text-golddim",children:e.totalText})]}),a.jsx("p",{"code-path":"src\\components\\bazi-v2\\ChartDetails.tsx:233:7",className:"mt-4 whitespace-pre-line border-t border-golddim/15 pt-4 text-center font-serif text-[14.5px] leading-[2] text-inktext",children:e.verse}),a.jsx("p",{"code-path":"src\\components\\bazi-v2\\ChartDetails.tsx:236:7",className:"mt-3 text-center text-[11.5px] text-inkmuted",children:e.source})]})}export{_o as C,mo as G,Oo as M,No as R,$o as S,Eo as T,ho as a};
